...
class Player:
    ...
    def place_ships(self):
        ...
        for ship in ships:
            while True:
                print(f"{self.name}, ubica tu {ship.name} de tamaño {ship.size}.")
        ...
        while True:
            ...
            if 0 <= row < 10 and 0 <= col < 10:
                if opponent.board[row][col] == '':
                    ...
                    print("Ya has atacado esa posición, intenta de nuevo.")
            else:
...
class BattleshipGame:
    ...
    def play(self):
        print(f"Bienvenido al juego de Batalla Naval!")
